...
Transazione::Transazione(double importo, year_month_day data, const string& descrizione, TipoTransazione tipo_) : importo(importo), data(data), descrizione(descrizione), tipo(tipo) {}
